...
public:
  ...
  void
  deleteRequest(std::list<std::shared_ptr<ArpRequest>>::iterator iterator);
  ...
  removeArpRequest(std::list<std::shared_ptr<ArpRequest>>::const_iterator arp_iterator);

  void 
  increment(std::list<std::shared_ptr<ArpRequest>>::const_iterator arp_iterator, time_point current_time);
